    ...
    <div class="container-fluid bg-dark mb-30">
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <nav href="" class="text-decoration-none mt-2">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between d-flex" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block me-4">
                            <div class=" dropdown dropstart bg-white">
                                <button class="btn btn-dark" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="fa-solid fa-user me-2"></i> {{Auth::user()->name}}
                                </button>
                                <ul class="dropdown-menu dropdown-menu-dark">
                                  <li><a class="dropdown-item my-2" href="{{route('user#detail')}}"><i class="fa-solid fa-user me-2"></i>Account</a></li>
                                  <li><a class="dropdown-item my-2" href="{{route('user#passwordChangePage')}}"><i class="fa-solid fa-key me-2"></i>Change Password</a></li>
                                  <li>
                                    <span class="dropdown-item text-center">
                                        <form action="{{route('logout')}}" class="d-inline" method="post">
                                            @csrf
                                            <button type="submit" class="btn btn-dark rounded text-white"><i class="fa-solid fa-right-from-bracket me-2"></i>Logout</button>
                                        </form>
                                    </span>
                                </li>
                                </ul>
