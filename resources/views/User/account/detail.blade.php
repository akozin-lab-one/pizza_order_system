        ...
        <div class="col-lg-6 offset-3">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('user#change', Auth::user()->id)}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-5 mt-3">
                                <div class="d-flex">
                                    ...
                                    <input class="ms-2 form-control col-9 @error('name') is-invalid @enderror" type="text" name="name" value="{{Auth::user()->name}}">
                                ...
                                <div class="d-flex">
                                    ...
                                    <input class="ms-2 form-control col-9 @error('email') is-invalid @enderror" type="text" name="email" value="{{Auth::user()->email}}">
                                ...
                                <div class="d-flex">
                                    ...
                                    <select name="gender" class="ms-2 form-control col-9">
                                ...
                                <div class="d-flex">
                                    ...
                                    <input class="ms-2 form-control col-9 @error('phone') is-invalid @enderror" type="text" name="phone" value="{{Auth::user()->phone}}">
                                ...
                                <div class="d-flex">
                                    ...
                                    <input class="ms-2 form-control col-9 @error('address') is-invalid @enderror" type="text" name="address" value="{{Auth::user()->address}}">
                                ...
                                <div class="d-flex">
                                    ...
                                    <input class="ms-2 form-control col-9" type="text" name="role" value="{{Auth::user()->role}}" disabled>
                                </div>
                                <br>
                            </div>
                        </div>
